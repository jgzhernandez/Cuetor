...
class _WagonWheelListState extends State<WagonWheelList> {
  Future<void> _deleteVideo(String videoId, String videoUrl) async {
    ...
    await FirebaseFirestore.instance.collection('wagon_wheel_results').doc(videoId).delete();
    setState(() {});
  }
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('wagon_wheel_results').where('uid', isEqualTo: FirebaseAuth.instance.currentUser?.uid)
            .snapshots(),
